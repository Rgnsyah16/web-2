        ...
        <div class="row">
            <div class="col-3">
                ...
                <div class="list-group">
                    ...
                    <a href="<?= base_url('admin/data-buku') ?>" class="list-group-item list-group-item-action<?= current_url() == base_url('index.php/admin/daftar-buku') ? 'active' : '' ?>" aria-current="true">
                        Daftar Buku</a>
                </div>
            </div>
            <div class=" col-9">
